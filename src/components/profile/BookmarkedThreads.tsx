...
interface BookmarkedThreadsProps {
  limit?: number;
}

export default function BookmarkedThreads({ limit }: BookmarkedThreadsProps) {
  const { user } = useAuth();
    ...
    const fetchBookmarkedThreads = async () => {
      try {
        ...
        const mockBookmarks: ForumThread[] = [
          ...
          {
            id: "4",
            title: "Traditional Indonesian fragrances and their modern interpretations",
            content:
              "Exploring the rich heritage of Indonesian fragrances and how they're being reimagined for modern perfumery...",
            user_id: "user4",
            category_id: "cat3",
            created_at: new Date(
          ...
          {
            id: "5",
            title: "Sustainable sourcing of fragrance ingredients",
            content:
              "A discussion on ethical and sustainable practices in sourcing ingredients for perfumery...",
            user_id: "user5",
            category_id: "cat4",
            created_at: new Date(
  ...
  const hasMore = limit && bookmarks.length > limit;
